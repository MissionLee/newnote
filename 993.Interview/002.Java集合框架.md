...
```java
    ...
    static final int tableSizeFor(int cap) { // 例如 cap = 10
        int n = cap - 1; // n = 9    1001  这是为了去除cap正好是2的整次幂时候的问题
...
[![jdk1.8之前的内部结构](https://images.xiaozhuanlan.com/photo/2019/6101f3a1e1921777b3d567b7270681d5.)](./res/012.png)

[jdk1.8之前的内部结构](./res/013.png)
