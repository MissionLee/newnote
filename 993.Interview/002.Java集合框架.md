...
```java
     ...
     * Returns a power of two size for the given target capacity.
     // 这份算法 是让最高位后面的位 全部变成1 ， 
     */
    static final int tableSizeFor(int cap) { // 例如 cap = 10
        int n = cap - 1; // n = 9    1001  这是为了去除cap正好是2的整次幂时候的
        n |= n >>> 1; // >>> 无符号右移 n = 1001||100 -> 1101
        n |= n >>> 2; //  n = 1101 || 11  -> 1111
        n |= n >>> 4;
        n |= n >>> 8;
        n |= n >>> 16;
        return (n < 0) ? 1 : (n >= MAXIMUM_CAPACITY) ? MAXIMUM_CAPACITY : n + 1;
        // 最终 n = 1111  就是 n = 15 ， return 16
    }
```
...
![JDK1.8之后的HashMap底层数据结构](./res/013.jpg)
...
HashTable:[![img](./res/014.png)](https://images.xiaozhuanlan.com/photo/2019/afbbc8a41589f37a0c911d3c820f3a5a.)

[img](https://images.xiaozhuanlan.com/photo/2019/afbbc8a41589f37a0c911d3c820f3a5a.)



**JDK1.7的ConcurrentHashMap：**[![img](./res/015.png)](https://images.xiaozhuanlan.com/photo/2019/1f5f73af91cb92ee405407985a50b677.)
