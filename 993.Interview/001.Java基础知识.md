# Java 基础知识
https://xiaozhuanlan.com/topic/1649538720
...
> hashCode（）与equals（）的相关规定 / MissionLee:这是开发约定，当对象有可能被放到Hash类型的集合中的时候，需要依靠hashCode(),equals()两个方法来保证代码按照“预计”的样子运行

- 如果两个对象相等，则hashcode一定也是相同的;
- 两个对象相等,对两个对象分别调用equals方法都返回true;
- 两个对象有相同的hashcode值，它们也不一定是相等的（不同的对象也可能产生相同的hashcode，概率性问题）;
