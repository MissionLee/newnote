...
自己想使用一些变量，但是自己毕竟对UI设计了解不多，选个颜色都很浪费时间，所以大量颜色想直接参考 element-ui的算了

然后根据 element ui 站点的介绍，尝试弄一下 https://github.com/ElementUI/element-theme

效果不好，引入element theme 之后，项目报错， 重新执行 yarn install 恢复，引入 element theme chalk之后也是这个问题

找到 刚刚下载的插件里面 element-theme-chalk ，找到源码，里面有 var.scss , 借用一下里面的颜色，加爵一下当前问题