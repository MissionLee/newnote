...
> 原文链接： http://www.mybatis.org/mybatis-3/zh/configuration.html
...
> Mission Lee ： 这一部分很好理解，主要是常用的各种参数在哪个阶段被使用
...
> Mission Lee ： settings 通过描述可以方便的理解，个人觉得此处主要要知道这些参数是如何在 MyBatis里面生效的
...
> 这里是比较好用的地方，把数据库的数据类型转换为Java中的数据类型
