...
idea可以直接使用 spring initialzer 创建项目，这里只选择 web中的web（添加 SpringMVC 与 Tomcat） 两个模块
...
- 我们开启debug功能，看看现在spring boot做了什么
  - 在 application.properties 里面添加debug=true
  - 开启debug模式可以看到当前spring boot为我们配置了什么内容
